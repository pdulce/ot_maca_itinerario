package giss.mad.marcocalidad.itinerariocalidad.controller;
...
import giss.mad.marcocalidad.itinerariocalidad.service.*;
import giss.mad.marcocalidad.itinerariocalidad.model.auxpesos.PesoGraph;
import giss.mad.marcocalidad.itinerariocalidad.model.auxumbrales.UmbralGraph;
...
public class ItinerarioController {
    ...
    public Collection<UmbralGraph> getUmbralesByElementCatalogo(@PathVariable Integer idTypeOfCatalogo) {
    ...
    public Collection<UmbralGraph> getUmbralesByDeliveryOfElement(@PathVariable Integer idTypeOfCatalogo) {
    ...
    public Collection<ActividadQAPantalla> getActivitiesIncludedById(@PathVariable Integer idItinerario) {
        Collection<ActividadQAPantalla> c = this.itinerarioCalidadService.getActivitiesByItineraryId(idItinerario, true);
        if (c == null) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND);
        }
        return c;
    ...
    public Collection<ActividadQAPantalla> getActivitiesExcludedById(@PathVariable Integer idItinerario) {
        Collection<ActividadQAPantalla> c = this.itinerarioCalidadService.getActivitiesByItineraryId(idItinerario, false);
        if (c == null) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND);
        }
        return c;
    ...
    public Collection<ActividadQAPantalla> getActivitiesByItineraryId(@PathVariable Integer idItinerario) {
        Collection<ActividadQAPantalla> c = this.itinerarioCalidadService.getActivitiesByItineraryId(idItinerario);
        if (c == null) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND);
        }
        return c;
    ...
    public Collection<StageBuble> getOnlyIncludedById(@PathVariable Integer idItinerario) {
        Collection<StageBuble> c= this.itinerarioCalidadService.getByIdItinerarioOnlyIncluded(idItinerario);
        if (c == null){
            throw new ResponseStatusException(HttpStatus.NOT_FOUND);
        }
        return c;
    ...
    public ItinerarioCalidad getItinerarioMasRecienteByIdElementOrEntrega(@PathVariable Integer idElementInstance) {
        ItinerarioCalidad c = this.itinerarioCalidadService.getItinerarioMasRecienteByIdElementOrEntrega(idElementInstance, false);
        if (c == null) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND);
        }
        return c;
    ...
    public Collection<ItinerarioCalidad> getAllItinerariosByIdElement(@PathVariable Integer idElementInstance) {
        Collection<ItinerarioCalidad> c = this.itinerarioCalidadService.getAllItinerariosByIdElementOrEntrega(idElementInstance, false);
        if (c == null) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND);
        }
        return c;
    ...
    public ItinerarioCalidad calculateItineraryWithDetailednfoElemen(@RequestBody @NotEmpty ReplicaElementOEntrega elementCatalogue) {
    ...
    public ItinerarioPantalla calculateItineraryElemen(@RequestBody @NotEmpty ReplicaElementOEntrega elementCatalogue) {
