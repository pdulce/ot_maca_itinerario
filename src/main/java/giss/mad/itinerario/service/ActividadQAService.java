...
public class ActividadQAService {
  ...
  private static List<String> actividades = List.of("RevisiÃ³n Requisitos",
      "RevisiÃ³n de Historias de usuario",
      "DiseÃ±o planes prueba Funcional", "DiseÃ±o planes prueba Rendimiento",
      "AnÃ¡lisis de cÃ³digo estÃ¡tico",
      "Pruebas unitarias", "MOCS", "API Testing", "Pruebas de IntegraciÃ³n",
      "Pruebas de AceptaciÃ³n", "Pruebas Funcionales de ProgresiÃ³n",
      "Pruebas Funcionales de RegresiÃ³n", "Pruebas de Carga", "Pruebas de EstrÃ©s",
      ...
      "Pruebas de Accesibilidad", "EvaluaciÃ³n HeurÃ­stica", "Tests con usuarios", "OmniaUsability",
      "AutomatizaciÃ³n de Pruebas Funcionales", "AutomatizaciÃ³n de Pruebas de APIs",
      "AnÃ¡lisis de IA");
  ...
  static {
    ...
    umbralesIdeales.put(
        "Funcionalidades crÃ­ticas 100 % OK, Resto de funcionalidades 80 % OK y SIN defectos bloqueantes",
        List.of(10));
    umbralesIdeales.put(
        "Funcionalidades crÃ­ticas 100 % OK, Resto de funcionalidades 90 % OK y SIN defectos bloqueantes",
        List.of(11));
    umbralesIdeales.put(
        "Trans / seg un 15 % superior al nivel de accesos esperado y Porcentaje de errores < 5 % en funcionalidades crÃ­ticas",
        List.of(13, 14, 15, 16, 17, 18));
    umbralesIdeales.put(
        "Sin vulnerabilidades de criticidad 2 y 3 segÃºn criterios CSI, 100% crÃ­ticas y 80% resto",
        List.of(19, 20, 21, 22, 23));
    umbralesIdeales.put("Nivel AA en pautas WCAG2  100% frontales crÃ­ticas y 80% del resto",
        List.of(24));
    umbralesIdeales.put("Cobertura del 75 % de funcionalidades crÃ­ticas y del 50 % en el resto",
        List.of(28));
