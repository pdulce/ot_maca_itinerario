...
public class PesosProyecto implements IPesosActividades {
  ...
  public Map<Integer, List<Weight>> getPesosPorActividades(RestTemplate restTemplate) {
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(20, 8, 6, 0)).getPesos());
    listaPesosActividades.get(number_activity)
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(50, 9, 7, 5)).getPesos());
    listaPesosActividades.get(number_activity)
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(20, 10, 10, 6)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[13],  /*pesos*/List.of(20, 10, -1)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(20, 10, 8, 6)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[13],  /*pesos*/List.of(20, 10, 1)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[14],  /*pesos*/List.of(20, 10, 1)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(30, 8, 4, 2)).getPesos());
    mapaDeActividadesConPesos.put(ACTIVITY[10], listaPesosActividades.get(number_activity));
    number_activity++;

    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(30, 10, 6, 4)).getPesos());
    mapaDeActividadesConPesos.put(ACTIVITY[11], listaPesosActividades.get(number_activity));
    number_activity++;

    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(30, 15, 8, 1)).getPesos());
    mapaDeActividadesConPesos.put(ACTIVITY[12], listaPesosActividades.get(number_activity));
    number_activity++;

    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(50, 8, 6, 2)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[13],  /*pesos*/List.of(20, 10, 1)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(40, 8, 6, 2)).getPesos());
    listaPesosActividades.get(number_activity)
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(10, 8, 6, 2)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[13],  /*pesos*/List.of(20, 10, 1)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(60, 30, 8, 6)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[13],  /*pesos*/List.of(20, 10, 5)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[14],  /*pesos*/List.of(20, 10, 5)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(20, 15, 8, 6)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[13],  /*pesos*/List.of(20, 10, 5)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[14],  /*pesos*/List.of(20, 10, 5)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(30, 10, 8, 2)).getPesos());
    mapaDeActividadesConPesos.put(ACTIVITY[25], listaPesosActividades.get(number_activity));
    number_activity++;

    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(20, 10, 8, 4)).getPesos());
    mapaDeActividadesConPesos.put(ACTIVITY[26], listaPesosActividades.get(number_activity));
    number_activity++;

    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(20, 10, 5, 2)).getPesos());
