...
public class PesoEjeIniciador {
  ...
  public final Map<Map<Integer, Boolean>, Map<Integer, List<Weight>>> getElementsOfCatalogo() {
    ...
    Map<Integer, List<Weight>> mapaDeActividadesConPesos_ElementoPromocionable = new PesosElementoPromocionable().getPesosPorActividades(
        restTemplate);
    Map<Integer, List<Weight>> mapaDeActividadesConPesos_EntregaElementoPromocionable = new PesosEntregaElementoPromocionable().getPesosPorActividades(
        restTemplate);

    Map<Integer, List<Weight>> mapaDeActividadesConPesos_AgrupacionFuncional = new PesosAgrupacionFuncional().getPesosPorActividades(
        restTemplate);
    Map<Integer, List<Weight>> mapaDeActividadesConPesos_EntregaAgrupacionFuncional = new PesosEntregaAgrupacionFuncional().getPesosPorActividades(
        restTemplate);

    Map<Integer, List<Weight>> mapaDeActividadesConPesos_Proyecto = new PesosProyecto().getPesosPorActividades(
        restTemplate);
    Map<Integer, List<Weight>> mapaDeActividadesConPesos_EntregaProyecto = new PesosEntregaProyecto().getPesosPorActividades(
        restTemplate);
