...
public class PesosEntregaAgrupacionFuncional implements IPesosActividades {
  ...
  public Map<Integer, List<Weight>> getPesosPorActividades(RestTemplate restTemplate) {
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[18],  /*pesos*/List.of(0, 0, -1, -1)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[7],  /*pesos*/List.of(-1, 0)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[15],  /*pesos*/List.of(10, 1)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[18],  /*pesos*/List.of(10, 7, -1, -1)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[1],  /*pesos*/List.of(10, 3)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[7],  /*pesos*/List.of(-1, 0)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[18],  /*pesos*/List.of(10, 8, 2, -1)).getPesos());
    listaPesosActividades.get(number_activity).addAll(
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[1],  /*pesos*/List.of(10, 3)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[13],  /*pesos*/List.of(50, 0)).getPesos());
    listaPesosActividades.get(number_activity)
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[18],  /*pesos*/List.of(10, 9, 9, 8)).getPesos());
    listaPesosActividades.get(number_activity).addAll(
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[1],  /*pesos*/List.of(10, 6)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[14],  /*pesos*/List.of(20, 10, 5)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[15],  /*pesos*/List.of(10, 5)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[18],  /*pesos*/List.of(10, 8, 6, 1)).getPesos());
    listaPesosActividades.get(number_activity).addAll(
        new PesosEje(restTemplate, AXE[19],  /*pesos*/List.of(5, 20, 10, 20, 10, 10)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[13],  /*pesos*/List.of(10, 0)).getPesos());
    listaPesosActividades.get(number_activity)
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[15],  /*pesos*/List.of(10, 1)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[18],  /*pesos*/List.of(10, 9, 7, 4)).getPesos());
    listaPesosActividades.get(number_activity).addAll(
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[18],  /*pesos*/List.of(10, 8, 4, 2)).getPesos());
    listaPesosActividades.get(number_activity).addAll(
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[7],  /*pesos*/List.of(0, 10)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[18],  /*pesos*/List.of(20, 15, 5, -1)).getPesos());
    listaPesosActividades.get(number_activity).addAll(
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[1],  /*pesos*/List.of(10, 2)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[7],  /*pesos*/List.of(10, 0)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[13],  /*pesos*/List.of(10, 0)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[15],  /*pesos*/List.of(10, 1)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[18],  /*pesos*/List.of(10, 10, 1, -1)).getPesos());
    listaPesosActividades.get(number_activity).addAll(
        new PesosEje(restTemplate, AXE[19],  /*pesos*/List.of(10, 20, 10, 20, 5, 10)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[13],  /*pesos*/List.of(10, 0)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[18],  /*pesos*/List.of(10, 10, 7, 1)).getPesos());
    listaPesosActividades.get(number_activity).addAll(
    ...
    listaPesosActividades.get(number_activity)
        .addAll(listaPesosActividades.get(number_activity - 1));
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[18],  /*pesos*/List.of(10, 8, 7, 5)).getPesos());
    listaPesosActividades.get(number_activity).addAll(
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[13],  /*pesos*/List.of(60, 0)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[14],  /*pesos*/List.of(20, 10, 5)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[15],  /*pesos*/List.of(30, 5)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[1],  /*pesos*/List.of(10, 5)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[13],  /*pesos*/List.of(10, 0)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[14],  /*pesos*/List.of(20, 10, 5)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[7],  /*pesos*/List.of(0, 10)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[18],  /*pesos*/List.of(10, 8, 3, -1)).getPesos());
    listaPesosActividades.get(number_activity).addAll(
