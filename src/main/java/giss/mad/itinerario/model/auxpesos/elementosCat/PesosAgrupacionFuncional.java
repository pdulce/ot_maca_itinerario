...
public class PesosAgrupacionFuncional implements IPesosActividades {
  ...
  public Map<Integer, List<Weight>> getPesosPorActividades(RestTemplate restTemplate) {
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[10],  /*pesos*/List.of(0, 0)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[12],  /*pesos*/List.of(10, 1)).getPesos());
    listaPesosActividades.get(number_activity)
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[1], /*pesos*/List.of(10, 5, 1)).getPesos());
    listaPesosActividades.get(number_activity).addAll(
        new PesosEje(restTemplate, AXE[4],  /*pesos*/List.of(5, 10, 10, 10, 10)).getPesos());
    listaPesosActividades.get(number_activity)
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[21],  /*pesos*/List.of(0, 0, 0, 0)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[5],  /*pesos*/List.of(20, 10, 5)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[6],  /*pesos*/List.of(150, 50, 20, 0)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[13],  /*pesos*/List.of(20, 10, 5)).getPesos());
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[14],  /*pesos*/List.of(20, 10, 5)).getPesos());
    ...
    listaPesosActividades.get(number_activity)
        .addAll(new PesosEje(restTemplate, AXE[20],  /*pesos*/List.of(10, 20, 5)).getPesos());
    listaPesosActividades.get(number_activity)
