...
public class UmbralesElementoPromocionable implements IUmbralesActividades {
    ...
    public Map<Integer, List<Umbral>> getUmbralesPorActividades(Integer elementType, Boolean isDelivery) {
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(30, 9999, "Realizar entre un 70% y un 80% sobre todos los requisitos", false));
        listaUmbralesActividades.get(number_activity).add(
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(30, 9999, "Realizar un 80%", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(0, 29, "Realizar un 60%", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(100,  9999, "Realizar el 100% sobre funcionalidades crÃ­ticas, y al menos un 90% en el resto", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(50, 99, "Realizar el 80% sobre funcionalidades crÃ­ticas, y al menos un 70% en el resto", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(80,  9999, "Trans / seg un 15 % superior al nivel de accesos esperado, Porcentaje de errores < 5 % en funcionalidades crÃ­ticas", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(50, 79, "Trans / seg un 5% superior al nivel de accesos esperado, Errores < 10 %  crÃ­ticas", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(60,  9999, "Trans / seg un 15 % superior al nivel de accesos esperado, Porcentaje de errores < 5 % en funcionalidades crÃ­ticas", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(30, 59, "Trans / seg un 5% superior al nivel de accesos esperado, Errores < 10 %  crÃ­ticas", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(50, 99, "Nivel AA en pautas WCAG2 80% frontales crÃ­ticas, 60% del resto", false));
        mapaDeActividadesConUmbrales.put(ACTIVITY[25], listaUmbralesActividades.get(number_activity));
        number_activity++;

        listaUmbralesActividades.get(number_activity).add(
                new Umbral(100,  9999, "80% puntos lista OK", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(50, 99, "60% puntos lista OK", false));
