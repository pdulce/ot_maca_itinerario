...
public class UmbralesProyecto implements IUmbralesActividades {
  ...
  public Map<Integer, List<Umbral>> getUmbralesPorActividades(Integer elementType,
    ...
    listaUmbralesActividades.get(number_activity).add(
        new Umbral(30, 9999, "Nivel AA en pautas WCAG2  100% frontales crÃ­ticas, 80% del resto",
            false));
    listaUmbralesActividades.get(number_activity).add(
        new Umbral(10, 29, "Nivel AA en pautas WCAG2 80% frontales crÃ­ticas, 60% del resto",
            false));
