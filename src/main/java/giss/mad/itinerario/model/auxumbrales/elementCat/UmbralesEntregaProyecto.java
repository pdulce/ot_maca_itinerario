...
public class UmbralesEntregaProyecto implements IUmbralesActividades {
    ...
    public Map<Integer, List<Umbral>> getUmbralesPorActividades(Integer elementType, Boolean isDelivery) {
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(20, 9999, "Realizar un 95% sobre requisitos crÃ­ticos", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(0, 19, "Realizar en un 80% sobre los requisitos crÃ­ticos", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(40,  9999, "Realizar al menos un 75%", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(15, 39, "Realizar un 50%", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(0,  9999, "Realizar el 100% sobre funcionalidades crÃ­ticas, y al menos un 80% en el resto", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(50, 79, "Realizar el 80% sobre funcionalidades crÃ­ticas, y al menos un 60% en el resto", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(0, 19, "Trans / seg un 5% superior al nivel de accesos esperado, Errores < 10 %  crÃ­ticas", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(40,  9999, "Sin vulnerabilidades de criticidad 2 y 3 segÃºn criterios CS, 100% crÃ­ticas, 80% resto", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(15, 39, "Sin vulnerabilidades de criticidad  3 segÃºn criterios CSI, 100% crÃ­ticas, 80% resto", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(20,  9999, "Cobertura del 75 % de funcionalidades crÃ­ticas y del 50 % en el resto", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(10, 19, "40 %  crÃ­ticas, 20 % resto", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(10, 49, "40 %  crÃ­ticas, 20 % resto", false));
