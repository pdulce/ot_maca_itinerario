...
public class UmbralesAgrupacionFuncional implements IUmbralesActividades {
    ...
    public Map<Integer, List<Umbral>> getUmbralesPorActividades(Integer elementType, Boolean isDelivery) {
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(70, 9999, "Realizar el 100% sobre requisitos crÃ­ticos, y al menos un 80 % en el resto", false));
        listaUmbralesActividades.get(number_activity).add(
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(80,  9999, "Realizar el 100% sobre funcionalidades crÃ­ticas, y al menos un 80% en el resto", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(20, 79, "Realizar el 80% sobre funcionalidades crÃ­ticas, y al menos un 60% en el resto", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(30, 49, "Realizar el 80% sobre funcionalidades crÃ­ticas, y al menos un 60% en el resto", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(100,  9999, "Realizar el 100% sobre funcionalidades crÃ­ticas, y al menos un 80% en el resto", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(60, 99, "Realizar el 80% sobre funcionalidades crÃ­ticas, y al menos un 60% en el resto", false));
        mapaDeActividadesConUmbrales.put(ACTIVITY[11], listaUmbralesActividades.get(number_activity));
        number_activity++;

        listaUmbralesActividades.get(number_activity).add(
                new Umbral(120,  9999, "Realizar el 100% sobre funcionalidades crÃ­ticas, y al menos un 90% en el resto", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(70, 119, "Realizar el 80% sobre funcionalidades crÃ­ticas, y al menos un 70% en el resto", false));
        mapaDeActividadesConUmbrales.put(ACTIVITY[12], listaUmbralesActividades.get(number_activity));
        number_activity++;

        listaUmbralesActividades.get(number_activity).add(
                new Umbral(90,  9999, "Trans / seg un 15 % superior al nivel de accesos esperado, Porcentaje de errores < 5 % en funcionalidades crÃ­ticas", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(50, 89, "Trans / seg un 5% superior al nivel de accesos esperado, Errores < 10 %  crÃ­ticas", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(100,  9999, "Trans / seg un 15 % superior al nivel de accesos esperado, Porcentaje de errores < 5 % en funcionalidades crÃ­ticas", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(50, 99, "Trans / seg un 5% superior al nivel de accesos esperado, Errores < 10 %  crÃ­ticas", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(30, 69, "Trans / seg un 5% superior al nivel de accesos esperado, Errores < 10 %  crÃ­ticas", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(100,  9999, "Trans / seg un 15 % superior al nivel de accesos esperado, Porcentaje de errores < 5 % en funcionalidades crÃ­ticas", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(60, 99, "Trans / seg un 5% superior al nivel de accesos esperado, Errores < 10 %  crÃ­ticas", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(30, 39, "Trans / seg un 5% superior al nivel de accesos esperado, Errores < 10 %  crÃ­ticas", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(200,  9999, "Sin vulnerabilidades de criticidad 2 y 3 segÃºn criterios CS, 100% crÃ­ticas, 80% resto", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(100, 199, "Sin vulnerabilidades de criticidad  3 segÃºn criterios CSI, 100% crÃ­ticas, 80% resto", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(160,  9999, "Sin vulnerabilidades de criticidad 2 y 3 segÃºn criterios CS, 100% crÃ­ticas, 80% resto", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(80, 159, "Sin vulnerabilidades de criticidad  3 segÃºn criterios CSI, 100% crÃ­ticas, 80% resto", false));
        mapaDeActividadesConUmbrales.put(ACTIVITY[23], listaUmbralesActividades.get(number_activity));
        number_activity++;

        listaUmbralesActividades.get(number_activity).add(
                new Umbral(120,  9999, "Sin vulnerabilidades de criticidad 2 y 3 segÃºn criterios CS, 100% crÃ­ticas, 80% resto", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(80, 119, "Sin vulnerabilidades de criticidad  3 segÃºn criterios CSI, 100% crÃ­ticas, 80% resto", false));
        mapaDeActividadesConUmbrales.put(ACTIVITY[24], listaUmbralesActividades.get(number_activity));
        number_activity++;

        listaUmbralesActividades.get(number_activity).add(
                new Umbral(100,  9999, "Nivel AA en pautas WCAG2  100% frontales crÃ­ticas, 80% del resto", false));
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(60, 99, "Nivel AA en pautas WCAG2 80% frontales crÃ­ticas, 60% del resto", false));
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(140,  9999, "Cobertura del 75 % de funcionalidades crÃ­ticas y del 50 % en el resto", false));
        listaUmbralesActividades.get(number_activity).add(
        ...
        listaUmbralesActividades.get(number_activity).add(
                new Umbral(170,  9999, "Cobertura del 75 % de funcionalidades crÃ­ticas y del 50 % en el resto", false));
        listaUmbralesActividades.get(number_activity).add(
